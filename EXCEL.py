...
workbook = openpyxl.load_workbook('C:/Users/VAIO-L/Desktop/torihiki.xlsx')
...
for i in suppliers:
    ...
    for j in range(3,9):
        ...
        if supplier == j:
            transaction_amount += sheet.call(row=j, column=6).value
...
workbook.save("C:/Users/VAIO-L/Desktop/torihiki.xlsx")
